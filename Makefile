...
mock:
	...
	@mockgen -source=E:/gowork/src/basic-go/webook/pkg/ratelimit/types.go -package=limitmocks -destination=E:/gowork/src/basic-go/webook/pkg/ratelimit/mocks/ratelimit.mock.go
#模拟redis
